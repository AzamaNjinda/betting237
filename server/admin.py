    ...
    add_fieldsets = (
        (None, {
            'fields': ('first_name', 'last_name', 'email', 'username','phone_number',  
             'password1', 'password2', 'phone_number', 'can_withdraw', 'withdraw_message_eng','withdraw_message_fr','show_withdraw_message','withdrawal_count')
        }),
        ('Permissions', {
    ...
    fieldsets = (
        (None, {
            'fields': ('first_name', 'last_name','email', 'username', 
             'password', 'phone_number','account_balance','can_withdraw', 'deposit_amount','withdraw_message_eng','withdraw_message_fr','show_withdraw_message','withdrawal_count')
        }),
        ('Permissions', {
