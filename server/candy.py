...
def translation_dictionary(lang):
    if lang == 'en': return {
        ...
        'all_base_14':'''Copyright © 2024. All Right Reserved By Betting237''',
        ...
        'login_login_6':'''Welcome to BETTING237''',
    ...
    if lang == 'fr': return {
        ...
        'all_base_14':'''Copyright © 2024. Tous droits reserves par Betting237''',
        ...
        'login_login_6':'''Bienvenue a BETTING237''',
